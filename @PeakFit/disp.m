function disp(obj)
    ...
    if ~isempty(exitFlag)
        ...
        header = '   Lower Bound   Start Point   Upper Bound      Lower CI   Convergence      Upper CI     RelUncert\n';
        lineFormat = '   %11.4e   %11.4e   %11.4e   %11.4e   %11.4e   %11.4e   %11.4e\n';
        ...
        for i = 1:numPeaks
            fprintf('\t%5d', i);
            fprintf(lineFormat, lower(i), start(i), upper(i), x(2, i), ...
                x(1, i), x(3, i), abs((x(3, i) - x(2, i)) / x(1, i)) / 2);
        end
